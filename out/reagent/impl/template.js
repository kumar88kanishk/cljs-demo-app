...
var G__938 = o;
goog.object.set(G__938,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__939__delegate = function (args){
...
while (G__940__i < G__940__a.length) {G__940__a[G__940__i] = arguments[G__940__i + 0]; ++G__940__i;}
  args = new cljs.core.IndexedSeq(G__940__a,0,null);
} 
return G__939__delegate.call(this,args);};
G__939.cljs$lang$maxFixedArity = 0;
G__939.cljs$lang$applyTo = (function (arglist__941){
var args = cljs.core.seq(arglist__941);
return G__939__delegate(args);
});
...
var G__942 = o;
goog.object.set(G__942,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__946 = props;
var G__946__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__946,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__946);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__946__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__946__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__947 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__947,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__947;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__948){
var map__949 = p__948;
...
var on_write = cljs.core.get.call(null,map__949__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__949,map__949__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__949,map__949__$1,on_write))
);
} else {
...
return (function (p1__951_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__951_SHARP_);
});})(v,value,on_change))
;
} else {
return null;
...
var vec__954 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__954,(0),null);
var id = cljs.core.nth.call(null,vec__954,(1),null);
var className = cljs.core.nth.call(null,vec__954,(2),null);
...
var temp__5739__auto___958 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5739__auto___958 == null)){
} else {
var key_959 = temp__5739__auto___958;
jsprops.key = key_959;
}
...
var temp__5739__auto___960 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5739__auto___960 == null)){
} else {
var key_961 = temp__5739__auto___960;
jsprops.key = key_961;
}
...
var temp__5739__auto___962 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___962 == null)){
} else {
var key_963 = temp__5739__auto___962;
jsprops.key = key_963;
}
...
var G__965 = n;
if(cljs.core._EQ_.call(null,"",G__965)){
return x;
} else {
if(cljs.core._EQ_.call(null,null,G__965)){
return x;
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq966){
var G__967 = cljs.core.first.call(null,seq966);
var seq966__$1 = cljs.core.next.call(null,seq966);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__967,seq966__$1);
});
...
break;
default:
var G__973 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__973;
continue;
...
var ctx = ({});
var vec__975 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__975,(0),null);
var derefed = cljs.core.nth.call(null,vec__975,(1),null);
...
var G__978 = (cljs.core.count.call(null,argv) - first_child);
switch (G__978) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__978){
